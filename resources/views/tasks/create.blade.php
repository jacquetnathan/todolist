        ...
        <div class="w-full sm:max-w-lg mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
          ...
          <form method="POST" action="{{ route('store') }}">
              ...
              <div class="mt-4">
                  ...
                  <textarea class="form-input rounded-md shadow-sm mt-1" style="width: 100%" id="description" name="description" placeholder="Détail de la tâche">{{ old('description') }}</textarea>
              </div>
